        ...
        frame = pd.DataFrame(
            {
                ...
                "cloud_liquid_mixing_ratio_kgkg": [0.00020, 0.00010, 0.00005, 0.0],
                "cloud_ice_mixing_ratio_kgkg": [0.0, 0.0, 0.00002, 0.00005],
                "rain_mixing_ratio_kgkg": [0.0, 0.0, 0.0, 0.0],
                "snow_mixing_ratio_kgkg": [0.0, 0.0, 0.0, 0.0],
                "graupel_mixing_ratio_kgkg": [0.0, 0.0, 0.0, 0.0],
            }
        )
