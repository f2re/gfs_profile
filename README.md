...
PNG содержит название пункта, модель и центр, период действия, местное время, время получения и генерации, расчётную точку, температуру/точку росы, влажность, облачность, осадки, ветер, порывы и давление. Для ансамбля показываются центр, q25–q75, q10–q90 и сырые вероятности осадков.
