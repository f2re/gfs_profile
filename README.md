...
PNG содержит название пункта, модель и центр, период действия, местное время, время получения и генерации, расчётную точку, температуру/точку росы, влажность, облачность, осадки, ветер, порывы и давление. Для ансамбля показываются центр, q25–q75, q10–q90, полнота членов и сырые вероятности осадков.

Компоновка синхронизирована с проверенным рендером `weather-to-docx`: легенды вынесены над панелями, осадки приведены к единой шкале мм/ч, следы показаны отдельными маркерами, обычные столбики не имеют чёрной обводки, а термины «сильный ветер» и «сильные порывы» не смешиваются.
