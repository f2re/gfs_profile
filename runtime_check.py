...
OPTIONAL_RUNTIME_MODULES = (
    ...
    "telegram_meteogram", "telegram_meteogram_common", "telegram_schedules", "telegram_schedule_ux", "telegram_bot_core",
    "telegram_concise_ux", "telegram_result_copy", "messenger.contracts", "messenger.callback_codec", "messenger.state",
    "messenger.platform_config", "messenger.runtime_resources", "messenger.profile_service", "messenger.aero_service",
    "messenger.windgram_service", "messenger.cloudgram_service", "messenger.map_service", "messenger.meteogram_service",
    "messenger.router", "messenger.personal_router", "messenger.aero_router", "messenger.windgram_router", "messenger.cloudgram_router",
    "messenger.map_router", "messenger.meteogram_router", "messenger.user_recipes", "messenger.max.client", "messenger.max.adapter",
    "messenger.max.gateway", "messenger.vk.client", "messenger.vk.adapter", "messenger.vk.gateway", "messenger.webhooks",
    "telegram_profile_common", "telegram_saved_recipes", "telegram_bot", "messenger_launcher", "messenger_runtime",
    "messenger_config_check", "prepare_messenger_config", "register_messenger_webhooks",
)
...
def main() -> int:
    ...
    print(
        ...
        "common profile/aero/windgram/cloudgram/map/meteogram services, messenger registration setup, route, "
        "schedules and Telegram/MAX/VK gateways import successfully"
    )
    return 0
