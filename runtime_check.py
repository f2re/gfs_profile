...
OPTIONAL_RUNTIME_MODULES = (
    ...
    "telegram_schedule_route_compat", "telegram_bot_core", "telegram_concise_ux", "telegram_result_copy",
    "messenger.contracts", "messenger.callback_codec", "messenger.state", "messenger.platform_config", "messenger.runtime_resources",
    "messenger.profile_service", "messenger.aero_service", "messenger.windgram_service", "messenger.cloudgram_service",
    "messenger.map_service", "messenger.meteogram_service", "messenger.route_service", "messenger.product_executor",
    "messenger.schedule_store", "messenger.scheduler", "messenger.router", "messenger.personal_router", "messenger.aero_router",
    "messenger.windgram_router", "messenger.cloudgram_router", "messenger.map_router", "messenger.meteogram_router",
    "messenger.route_router", "messenger.settings_router", "messenger.schedule_router", "messenger.user_recipes",
    "messenger.user_locations", "messenger.max.client", "messenger.max.adapter", "messenger.max.gateway", "messenger.vk.client",
    "messenger.vk.adapter", "messenger.vk.gateway", "messenger.webhooks", "telegram_profile_common", "telegram_saved_recipes",
    "telegram_bot", "messenger_launcher", "messenger_runtime", "messenger_config_check", "prepare_messenger_config",
...
def main() -> int:
    ...
    if errors: _print_errors(errors); return 1
    print("Runtime check OK: GFS/GRIB, DaData, shared runtime resources, independent platform lifecycle, common seven-product services, persistent settings, immutable schedules including Telegram route parity, messenger registration setup and Telegram/MAX/VK gateways import successfully")
    return 0
